...
Phiên bản ổn định hiện tại: **v1.3.0**  
...
```bash
cd /opt
sudo wget https://github.com/Shidaichiacc/QuanLy_One/releases/download/v1.3.0/JXNative-v1.3.0.tar.gz
sudo wget https://github.com/Shidaichiacc/QuanLy_One/releases/download/v1.3.0/JXNative-v1.3.0.tar.gz.sha256
sudo sha256sum -c JXNative-v1.3.0.tar.gz.sha256
sudo tar -xzf JXNative-v1.3.0.tar.gz -C /opt
cd /opt/QuanLy_One
